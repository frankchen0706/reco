...
/*
	...
	m_dictCore.AddItem(" Æ∑÷",'d'*256,+500);
	m_dictCore.AddItem(" Æ∑÷",'m'*256,-500);
	m_dictCore.AddItem("Œ“π˙",'n'*256,-2000);
	m_dictCore.AddItem("Œ“π˙",'r'*256,+2000);
	m_dictCore.AddItem("«ßƒÍ",'t'*256,200);
...
bool CResult::ParagraphProcessing(char *sParagraph,char *sResult)
{
	...
	{//Find a whole sentence which separated by ! . \n \r
		...
		nPosIndex+=1;
/*
#define  SEPERATOR_C_SENTENCE "°££°£ø£∫£ª°≠"
#define  SEPERATOR_C_SUB_SENTENCE "°¢£¨£®£©°∞°±°Æ°Ø"
